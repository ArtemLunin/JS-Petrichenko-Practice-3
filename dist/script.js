  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        this.hanson.style.opacity = '0'; //показываем его только на 3 слайде
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      // здесь мы пропускаем применение стилей к кнопкам (они находятся в верстке вместе со слайдами)
